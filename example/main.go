...
import (
	...
	"github.com/zzzhr1990/simpleupdater"
...
func prog(state simpleupdater.State) {
...
func main() {
	simpleupdater.Run(simpleupdater.Config{
		Program: prog,
		Address: ":5001",
		Fetcher: &fetcher.File{Path: "my_app_next"},
		Debug:   false, //display log of simpleupdater actions
	})
}
